              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div className="lg:col-span-3">
                  <label className="block text-sm font-semibold text-gray-700 mb-2">
                    ...
                    <input type="text" value={item.description} onChange={(e) => onUpdateItem(item.id, 'description', e.target.value)} placeholder="Enter product description" className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg transition" />
                </div>
                ...
                <div>
                  ...
                  <input type="text" value={item.brand} onChange={(e) => onUpdateItem(item.id, 'brand', e.target.value)} placeholder="Brand name" className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg transition" />
                </div>
                ...
                <div>
                  ...
                  <input type="text" value={item.model} onChange={(e) => onUpdateItem(item.id, 'model', e.target.value)} placeholder="Model or spec" className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg transition" />
                </div>
                ...
                <div>
                  ...
                  <input value={item.qty} onChange={(e) => onUpdateItem(item.id, 'qty', e.target.value)} min="1" placeholder="Qty" className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg transition" />
                </div>
                ...
                <div>
                  ...
                  <input type="number" value={item.rate} onChange={(e) => onUpdateItem(item.id, 'rate', e.target.value)} min="0" step="0.01" placeholder="Rate" className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg transition" />
                </div>
